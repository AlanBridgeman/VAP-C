...
export default function SignupPage() {
  ...
  async function onSubmit(e) {
    ...
    if (body['user-password'] !== e.currentTarget.rpassword.value) {
    ...
    <>
      ...
      <div className={(errorMsg) ? styles['form-container'] : styles['form-container-error']}>
        ...
        <Form.Group>
          ...
          <br />
          <Form.Group>
            <Form.Check type="checkbox" label={<Form.Label htmlFor="terms-agree">I have read and accept the <Link href="/Terms"><a>Terms of Service</a></Link></Form.Label>} name="terms-agree" id="terms-agree"required />
          </Form.Group>
          <br />
